...
<head>
    <meta charset="UTF-8">
        <meta name="mit" content="2020-02-19T22:05:11-03:00+50934">
...
<header class="main_header gradient gradient-green">
    <div class="container">
        <div class="main_header_logo">
            <h1><a class="icon-coffee transition" title="Home" href="<?= url(); ?>">Luver<b>Control</b></a></h1>
        </div>
...
<footer class="main_footer">
    <div class="container content">
        <section class="main_footer_content">
            ...
            <article class="main_footer_content_item">
                <h2>Contato:</h2>
                <p class="icon-phone"><b>Telefone:</b><br> +55 11 9807-52595</p>
                <p class="icon-envelope"><b>Email:</b><br> contato@luver.com.br</p>
            ...
            <article class="main_footer_content_item social">
                ...
                <a target="_blank" class="icon-youtube" href="https://www.youtube.com/<?= CONF_SOCIAL_YOUTUBE_PAGE; ?>"
                   title="CafeControl no YouTube">/LuverControl</a>
            </article>
        </section>
    </div>
</footer>
